...
#  then check the distribution of the target variable.
display(y['Diagnosis'].value_counts())

#  now process the data. Randomly choose 200 samples in 'M' (malignant) and 200 samples in 'B' (benign).
import pandas as pd
...
# we convert the NumPy arrays to PyTorch tensors.
...
model_new = ClassificationNet(input_units=30, hidden_units=36, output_units=2)
